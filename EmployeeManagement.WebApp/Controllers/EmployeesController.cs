...
namespace EmployeeManagement.WebApp.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(AppDbContexts context)
        {
            _context = context;
        }
        ...
        {
            var appDbContexts = _context.Employees.Include(e => e.Office);
        ...
        public async Task<IActionResult> Create(Employee employee)
        {
            ...
            ViewData["OfficeId"] = new SelectList(_context.Offices, "OfficeId", "Address", employee.OfficeId);
            return View(employee);
        }
